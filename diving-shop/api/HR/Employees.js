...
var dao = require('diving-shop/data/dao/HR/Employees');
var http = require('diving-shop/api/http');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Employees not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/diving-shop/api/Employees.js/' + entity.Id);

...
var dao = require('diving-shop/data/dao/HR/JobTypes');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('JobTypes not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/diving-shop/api/JobTypes.js/' + entity.Id);

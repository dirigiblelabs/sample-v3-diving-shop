...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'diving-shop.Catalog.Products.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('diving-shop.Catalog.Products.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v3/js/diving-shop/api/Catalog/Products.js';
